...
export class DatabaseSysStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
    ...
    */
    ...
    lambdaCoberturas.createResolver({
      typeName: "Mutation",
      fieldName: "registerCobertura",
    });

    //***  COTIZACIONES */
    lambdaCotizaciones.createResolver({
      typeName: "Mutation",
      fieldName: "registerCotizacion",
    });
